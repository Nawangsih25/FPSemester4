...
use App\Http\Controllers\Admin\PembayaranSimpananController;
...
// Login untuk Anggota dan Kolektor
...
Route::prefix('admin')->middleware(['auth'])->group(function () {
    ...
    // CRUD: Kolektor, Anggota, Pinjaman, Simpanan
    ...
    // Pinjaman: Permintaan - Setujui - Tolak - Review
    ...
    // ✅ Konfirmasi Pembayaran dari Anggota
    Route::get('/pembayaran', [PembayaranSimpananController::class, 'index'])->name('admin.pembayaran.index');
    Route::post('/pembayaran_simpanan/konfirmasi/{id}', [PembayaranSimpananController::class, 'konfirmasi'])->name('admin.pembayaran_simpanan.konfirmasi');
    Route::post('/pembayaran_simpanan/tolak/{id}', [PembayaranSimpananController::class, 'tolak'])->name('admin.pembayaran_simpanan.tolak');

    Route::post('/admin/pembayaran/simpan', [PembayaranController::class, 'store'])->name('pembayaran.simpan');
...
// Route untuk Anggota (Login sebagai anggota/kolektor)
